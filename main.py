...
#     lr = 4e-4
#
#     Resnet50 = torch.nn.DataParallel(model, device_ids=[0])
#
...
#             torch.save(model.state_dict(), f'/hpcdata/users/user011/rgye/wang/FGVC9/model_ parameter/best_score')
#
#         if avg_val_loss < best_loss:
#             best_loss = avg_val_loss
#             LOGGER.debug(f'  Epoch {epoch + 1} - Save Best Loss: {best_loss:.4f} Model')
#             torch.save(model.state_dict(), f'f/hpcdata/users/user011/rgye/wang/FGVC9/model_ parameter/best_loss')